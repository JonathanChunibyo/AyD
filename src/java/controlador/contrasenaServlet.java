 ...
 * @author Jose
 */
@WebServlet(name = "contrasenaServlet", urlPatterns = {"/contrasenaServlet"})
public class contrasenaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String cUno = request.getParameter("contra1");
            String cDos = request.getParameter("contra2");

            metodosUsuario mu = new metodosUsuario();

            if (mu.cambiarContra(c, cUno, cDos)) {
                datos = "Contraseña Modificada con Exito";
                ...
                datos = "No se Pudo Modificar la Contraseña";
                request.getSession().setAttribute("dato", datos);
