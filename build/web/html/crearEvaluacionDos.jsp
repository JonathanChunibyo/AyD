                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Evaluación de desempeño docente / Competencias Funcionales</h2>
                                    ...
                                    <div class="x_content">
                                        <form action="${pageContext.request.contextPath}/evaDosServlet">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="unoUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="dosUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="tresUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="cuatroUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <select id="inputState" class="form-control" name="cuatroDos">
                                                            <option>0</option>
                                                            <option>10</option>
                                                            <option>20</option>
                                                            <option>30</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="cincoUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <select id="inputState" class="form-control" name="cincoDos">
                                                            <option>0</option>
                                                            <option>10</option>
                                                            <option>20</option>
                                                            <option>30</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="seisUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <select id="inputState" class="form-control" name="seisDos">
                                                            <option>0</option>
                                                            <option>10</option>
                                                            <option>20</option>
                                                            <option>30</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="sieteUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <select id="inputState" class="form-control" name="sieteDos">
                                                            <option>0</option>
                                                            <option>10</option>
                                                            <option>20</option>
                                                            <option>30</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="input-group">
                                                        <input type="text" id="last-name" name="ochoUno" class="form-control " style="width: 470px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <select id="inputState" class="form-control" name="ochoDos">
                                                            <option>0</option>
                                                            <option>10</option>
                                                            <option>20</option>
                                                            <option>30</option>
