...
<html lang="en">
    <head>
        ...
        <%
            ...
            String docentes = mu.dibujarUsuario();
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div id="form1">
                                            <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/evaUnoServlet">
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Docente a evaluar:<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 ">
                                                        <div class="form-group ">
                                                            <select id="inputState" class="form-control" name="docente" required> 
                                                                <option>Docentes</option>
                                                                <%=docentes%>
                                                            </select>
                                                        </div>
                                                        <br><br>
                                                        <center><button type='submit' class="btn btn-primary">Seleccionar</button></center> 
                                                    </div>   
                                                </div>
                                            </form>
                                        </div>
