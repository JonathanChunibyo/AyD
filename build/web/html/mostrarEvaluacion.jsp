<%-- 
    Document   : mostrarEvaluacion
    Created on : 7/06/2021, 10:43:17 PM
    Author     : Jose
--%>
...
<html lang="en">
    <head>
        ...
        <%
            ...
            String tabla = "";
            if (request.getSession().getAttribute("evaluacionesRe") != null) {
                tabla = String.valueOf(request.getSession().getAttribute("evaluacionesRe"));
            }
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"><h4></h4><span class="required"></span>
                                            </label>
