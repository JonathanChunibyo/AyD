                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name"><h4>VALORACIÓN FINAL DE DESEMPEÑO</h4><span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <div class="input-group">
